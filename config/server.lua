return {
    ...
    player = {
        ...
        identifierTypes = {
            ...
            AccountNumber = {
                valueFunction = function()
                    return 'US0' .. math.random(1, 9) .. 'LSD' .. math.random(1111, 9999) .. math.random(1111, 9999) .. math.random(11, 99)
                end,
            },
            PhoneNumber = {
                valueFunction = function()
    ...
    server = {
        ...
        closedReason = 'Serveur fermé', -- Reason message to display when people can't join the server
    ...
    logging = {
        webhook = {
            ['default'] = 'https://discord.com/api/webhooks/1158864669029703700/IrwofOw0gTBXivsdK-asZX0F2HILzy5jsd_B8ReOirJira4vp8jXpL2JnEZDd6Y5rG5A', -- default
            ['joinleave'] = 'https://discord.com/api/webhooks/1158864669029703700/IrwofOw0gTBXivsdK-asZX0F2HILzy5jsd_B8ReOirJira4vp8jXpL2JnEZDd6Y5rG5A', -- default
            ['ooc'] = 'https://discord.com/api/webhooks/1158864669029703700/IrwofOw0gTBXivsdK-asZX0F2HILzy5jsd_B8ReOirJira4vp8jXpL2JnEZDd6Y5rG5A', -- default
            ['anticheat'] = 'https://discord.com/api/webhooks/1158864669029703700/IrwofOw0gTBXivsdK-asZX0F2HILzy5jsd_B8ReOirJira4vp8jXpL2JnEZDd6Y5rG5A', -- default
            ['playermoney'] = 'https://discord.com/api/webhooks/1158864669029703700/IrwofOw0gTBXivsdK-asZX0F2HILzy5jsd_B8ReOirJira4vp8jXpL2JnEZDd6Y5rG5A', -- default
        },
