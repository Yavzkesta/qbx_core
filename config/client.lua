return {
    ...
    pauseMapText = 'LSDream', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    characters = {
    ...
    discord = {
        ...
        appId = '1245179081784426576', -- This is the Application ID (Replace this with you own)
